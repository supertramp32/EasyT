...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.GeneralNotificationsViewHolder> {
    ...
    public NotificationsAdapter(List<GeneralNotifications.Data> notificationsData, Context context) {
    ...
    public GeneralNotificationsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final View v = LayoutInflater.from(context).inflate(R.layout.item_notification, parent, false);
        final GeneralNotificationsViewHolder viewHolder = new GeneralNotificationsViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull NotificationsAdapter.GeneralNotificationsViewHolder holder, int position) {
...
//            notTitle = itemView.findViewById(R.id.generalTitle);
            notDesc = itemView.findViewById(R.id.notificationDescription);
